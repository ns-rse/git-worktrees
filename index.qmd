...
{{< qrcode <https://blog.nshephard.dev/git-worktrees> qr1 width=400 height=400 >}}

[blog.nshephard.dev/git-worktrees](https://blog.nshephard.dev/git-worktrees)

## Git Worktrees

- First encountered in [2024](https://blog.nshephard.dev/posts/git-worktrees/)
...
drwxr-xr-x neil neil 4.0 KB Fri May  1 11:40:40 2026  worktrees
```
...
- Use a `post-checkout` hook 🪄
  - setup a virtual environment with [`uv`](https://docs.astral.sh/uv)
  - add a `.justfile` for the [`just`](https://just.systems/man/en/) runner
  - add a `.envrc` and allow [`direnv`](https://direnv.net/) in the worktree directory
...
{{< qrcode <https://blog.nshephard.dev/git-worktree-hooks> qr1 width=400 height=400 >}}

[blog.nshephard.dev/posts/git-worktree-hooks/](https://blog.nshephard.dev/posts/git-worktree-hooks/)
